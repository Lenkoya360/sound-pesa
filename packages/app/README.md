...
<div align="center">
  ...
  <img width="100" height="100" src="assets/mascot_head.png">
    <h1 align="center">Sound Pesa</h1>
  </div>

  <p align="center">
    A multi-chain wallet built with React Native
    <br />
...
Sound Pesa is a multi-chain cryptocurrency wallet built with React Native. This robust mobile application offers a comprehensive suite of features for managing digital assets across multiple blockchains, with a current focus on Ethereum and Solana networks.
...
Leveraging the power of Expo framework and Alchemy API, Sound Pesa provides a smooth, responsive user experience while ensuring reliable blockchain interactions. Whether you're a crypto enthusiast or a developer looking to explore mobile wallet implementation, Sound Pesa offers a feature-rich platform for managing digital currencies.

### Testnet-Only Application
**Important**: Sound Pesa is currently designed for use with the Ethereum Sepolia testnet and Solana Devnet only. It is not intended for use with real cryptocurrencies or on mainnet networks. This testnet focus allows for safe experimentation and development without risking actual digital assets.
...
### Development Focus
Sound Pesa serves as both a functional crypto wallet and a showcase of modern mobile development practices. It demonstrates the integration of blockchain technologies with React Native, emphasizing clean code architecture, robust state management with Redux, and a strong focus on security.

The mobile app is part of the Sound Pesa platform, a multi-chain decentralized exchange spanning Bitcoin, Ethereum, Cardano, and Polkadot. It continues to evolve, with ongoing work to expand blockchain support, enhance security features, and improve the overall user experience.
...
1. Clone the Sound Pesa monorepo and install dependencies from the workspace root:

```bash
git clone <sound-pesa-monorepo-url>
cd sound-pesa
npm install
```
...
```bash
npm run dev --workspace @sound-pesa/app
```

or run Expo directly from the app package:
...
Sound Pesa is continuously evolving. Here's our roadmap for future developments:
...
Your feedback and suggestions are always welcome as the team continues to improve and expand Sound Pesa!
